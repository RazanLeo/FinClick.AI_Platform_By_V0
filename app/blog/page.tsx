    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#B48500] mb-8">المدونة والأخبار</h1>
          <div className="bg-gradient-to-r from-[#0a0a0a] to-black border border-[#B48500] rounded-lg p-12">
            ...
            <p className="text-[#8B6914] text-lg">
              نعمل حالياً على إعداد المدونة والأخبار المالية. سيتم إطلاقها قريباً مع محتوى حصري ومفيد.
            </p>
          </div>
        </div>
      </div>
