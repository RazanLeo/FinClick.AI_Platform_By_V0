    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#B48500] mb-8">الإعلام</h1>
          <div className="bg-gradient-to-r from-[#0a0a0a] to-black border border-[#B48500] rounded-lg p-12">
            ...
            <p className="text-[#8B6914] text-lg">
              نعمل حالياً على إعداد قسم الإعلام والعلاقات العامة. سيتم إطلاقه قريباً مع آخر الأخبار والتغطيات الإعلامية.
            </p>
          </div>
        </div>
      </div>
